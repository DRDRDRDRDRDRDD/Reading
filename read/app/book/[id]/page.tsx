...
export default function BookPage() {
    ...
    const handleSubmitComment = (e: React.FormEvent) => {
        ...
        const newComment: Comment = {
            ...
            date: new Date().toLocaleDateString('ru-RU') // "26.12.2025"
        };
            ...
            <main className={styles.bookMain}>
                ...
                <div className={styles.bookInfo}>
                    ...
                    <div className={styles.similarBooks}>
                        <h3 className={styles.similarTitle}>ПОХОЖИЕ КНИГИ</h3>
                            ...
                            {bookDatabase
                                ...
                                .map(similarBook => (
                                    <Link
                                        ...
                                        className={styles.similarBookCard}
                                    >
                                        <Image
                                            ...
                                            width={80}
                                            height={120}
                                            className={styles.similarBookImage}
                                        />
                                        <div className={styles.similarBookInfo}>
                                            <h4 className={styles.similarBookTitle}>{similarBook.title}</h4>
                                            <p className={styles.similarBookAuthor}>{similarBook.author}</p>
                                        </div>
                                    </Link>
                                ))}
                        </div>
